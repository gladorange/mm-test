...
public class VirtualRoomV2 {
    ...
    protected List<AttendeeV2> attendee = new ArrayList<>();

    public VirtualRoomV2() {
     ...
     */
    public List<AttendeeV2> getAttendee() {
     ...
     */
    public void setAttendee(List<AttendeeV2> attendee) {
